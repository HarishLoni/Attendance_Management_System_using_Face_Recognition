    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:/HARISH/Projects/Attendance Management System using Face Recognition/Project/StudentDetails/' + DB_table_name + '.csv'

                with open(csv_name, "w") as csv_file:
                    csv_writer = csv.writer(csv_file)
                    csv_writer.writerow(['Enrollment', 'Name', 'Date', 'Time'])
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'D:/HARISH/Projects/Attendance Management System using Face Recognition/Project/StudentDetails/'+ fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
        r'explorer /select,"D:\\HARISH\\Projects\\Attendance Management System using Face Recognition\\Project\\StudentDetails\\-------Check attendance-------"' )
    ...
    def log_in():
        ...
        if username == 'Harish':
            if password == 'Harish@123':
                ...
                cs = 'D:/HARISH/Projects/Attendance Management System using Face Recognition/Project/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
>>>>>>> adaaec69be18373f35f57d9773baa97c96dbc934
window.mainloop()